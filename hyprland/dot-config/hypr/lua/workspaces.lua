...
hl.workspace_rule({ workspace = "1", monitor = "desc:" .. monitors.DELL, persistent = true })
hl.workspace_rule({ workspace = "2", monitor = "desc:" .. monitors.LG, persistent = true })
hl.workspace_rule({ workspace = "3", monitor = "desc:" .. monitors.LG, persistent = true })
hl.workspace_rule({ workspace = "4", monitor = "desc:" .. monitors.LG,   persistent = true })
...
hl.workspace_rule({ workspace = "9", monitor = "desc:" .. monitors.DELL, persistent = true })
hl.workspace_rule({ workspace = "0", monitor = "desc:" .. monitors.DELL, persistent = true })
...
hl.workspace_rule({ workspace = "f[1]",          gaps_out = theme.SPACE_SM })

-- Special workspaces
hl.workspace_rule({ workspace = "name:special:notes", monitor = "desc:" .. monitors.LG   })
hl.workspace_rule({ workspace = "name:special:term", monitor = "desc:" .. monitors.LG    })
