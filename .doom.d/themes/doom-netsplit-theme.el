;; doom-netsplit-theme.el --- inspired by Textmate's Monokai -*- no-byte-compile: t; -*-
(require 'doom-themes)

;;
(defgroup doom-netsplit-theme nil
  "Options for doom-netsplit."
  :group 'doom-themes)

(defcustom doom-netsplit-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-netsplit-theme
  :type 'boolean)

(defcustom doom-netsplit-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-netsplit-theme
  :type 'boolean)

(defcustom doom-netsplit-comment-bg doom-netsplit-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'doom-netsplit-theme
  :type 'boolean)

(defcustom doom-netsplit-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme doom-netsplit
  ...
  ((bg         '("#1c1e1f" nil       nil          ))
   ...
   (-modeline-bright doom-netsplit-brighter-modeline) ;; no effect for the moment
   (-modeline-pad
    (when doom-netsplit-padded-modeline
      (if (integerp doom-netsplit-padded-modeline) doom-netsplit-padded-modeline 4)))
...
;;; doom-netsplit-theme.el ends here
