return {
  {
    ...
    -- stylua: ignore
    keys = {
      { '<leader><cr>', ":Telescope resume<cr>",                                                    desc =
        'resume previous search' },
      { '<leader>T',    ":Telescope builtin<cr>",                                                   desc =
        'builtin Telescope commands' },
      { '<leader>/',    ':Telescope current_buffer_fuzzy_find<cr>',                                 desc =
      ...
      { '<leader>b',    ":Telescope buffers<cr>",                                                   desc =
        'Find existing buffers' },
      { '<c-b>',        ":Telescope buffers<cr>",                                                   desc =
        'Find existing buffers' },
      { '<leader>sC',   ":Telescope colorscheme enable_preview=true<cr>",                           desc =
        "search colors" },
      { '<M-r>',        ':Telescope lsp_dynamic_workspace_symbols<cr>',                             desc =
        'workspace symbols' },
      { '<leader>-',    ":Telescope file_browser path=%:p:h<cr>",                                   desc = 'search files' },
      { '<leader>sr',   ":Telescope oldfiles<cr>",                                                  desc =
        'search ecently opened files' },
      { '<leader>sh',   ":Telescope help_tags<cr>",                                                 desc = 'search help' },
      { '<leader>sc',   ":Telescope commands<cr>",                                                  desc =
        'search commands' },
      { '<leader>*',    ":Telescope grep_string<cr>",                                               desc =
        'search current word' },
